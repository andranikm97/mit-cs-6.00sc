...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while True:
        ...
        word = ''
        while True:
            word = input("Please enter a word (or enter '.' to quit): ")
            if (word == '.'):
            ...
            if not is_valid_word(word, hand, word_list):
                print('Invalid word, please enter another...\n\n')
                continue
